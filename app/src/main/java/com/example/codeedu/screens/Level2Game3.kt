...
/**Functionality for level 2 game 3- includes the game content ui*/
@Composable
fun Level2Game3(
    level: Int,
    ...
    val targetPosition = Offset(235f, 60f)

    val successConditionMet = (animatedPosition.x in targetPosition.x - 20f..targetPosition.x + 20f) &&
            (animatedPosition.y in targetPosition.y - 20f..targetPosition.y + 20f)
