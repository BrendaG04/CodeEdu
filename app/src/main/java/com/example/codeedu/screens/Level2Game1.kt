...
/**Functionality for level 2 game 1- includes the game content ui*/
@Composable
fun Level2Game1(
    level: Int,
    ...
    val commandSequence = remember { mutableStateListOf<Command?>(null, null,null, null,null,null,null) }
    ...
    val targetPosition = Offset(65f, 60f)

    val successConditionMet = (animatedPosition.x in targetPosition.x - 20f..targetPosition.x + 20f) &&
            (animatedPosition.y in targetPosition.y - 120f..targetPosition.y + 20f)
    ...
    Column(modifier = Modifier.fillMaxSize().background(Color(0xFFF3E5F5)).padding(8.dp)) {
        ...
        Text("YOUR SEQUENCE-LEVEL 2 GAME 1", style = MaterialTheme.typography.titleMedium)
        FlowRow(
